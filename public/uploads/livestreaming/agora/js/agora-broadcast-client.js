...
async function createCameraStream(uid, deviceIds) {
	...
	var microphoneId = jQuery('#mic-list').val();
	var cameraId = jQuery('#camera-list').val();
	//var microphoneId = devices.mics[mic_id].deviceId;
	//var cameraId = devices.cameras[cam_id].deviceId;
