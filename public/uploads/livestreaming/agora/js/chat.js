(function initChatApp($) {
	...
	$('#fav_emojis ul li').click(function(){
		var emojis = $(this).data('emoji');
		const uid = window.userID;
        const data = `CHATππ${uid}ππ${window.wp_username}ππ${emojis}`;
    ...
    function initNonUserActions() {
        ...
        // no need of validation. Join remote user directly
