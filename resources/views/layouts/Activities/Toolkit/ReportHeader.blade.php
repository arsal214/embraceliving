            ...
            <nav class="navbar navbar-expand-sm navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample07">
                    <ul class="nav navbar-nav mma_head">
                        <li class="nav-item" id="ar_generate_report"> <a href="javascript:void(0);">
                                <img src="{{ asset('images/generate.png') }}" alt="" width="80" height="60"><br>
                                Generate </a>
                        </li>
                        <li class="nav-item" id="ar_reset_report"> <a href="#">
                                <img src="{{ asset('images/reset.png') }}" alt="" width="80" height="60"><br>
                                Reset </a>
                        </li>
                        <li class="nav-item ar_export_report" data-export-type="all">
                            <a href="javascript:void(0)">
                                <img src="{{ asset('images/export2.png') }}" alt="" width="80" height="60"><br>
                                Export
                            </a>
                        </li>
                        <li class="nav-item ar_export_report" data-export-type="one">
                            <a href="javascript:void(0)">
                                <img src="{{ asset('images/export.png') }}" alt="" width="80" height="60"><br>
                                RPP
                            </a>
                        </li>
                        <li class="nav-item" id="mma_header_back"> <a href="/section/Toolkit/ActivityReporting" class="hBack"> <img
