            ...
            <nav class="navbar navbar-expand-sm navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample07">
                    <ul class="nav navbar-nav mma_head">
                        <li class="nav-item evidence_one_report_pdf" data-export-type="all">
                            <a href="javascript:void(0)">
                                <img src="{{ asset('images/export2.png') }}" alt="" width="80" height="60"><br>
                                Export
                            </a>
                        </li>
                        <li class="nav-item generate_evidence_report_pdf" data-export-type="all">
                            <a href="javascript:void(0)">
                                <img src="{{ asset('images/export2.png') }}" alt="" width="80" height="60"><br>
                                E.Export
                            </a>
                        </li>
                        <li class="nav-item" id="generate_evidence_report">
                            <a href="javascript:void(0);">
