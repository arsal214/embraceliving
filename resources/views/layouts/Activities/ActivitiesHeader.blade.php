        ...
        <div class="mma-header">
            <nav class="navbar navbar-expand-sm navbar">
                ...
                <a class="navbar-brand"><img
                        src="{{ asset('images/mma_logo_full.png') }}" alt="logo"
                        width="340" height="60" /></a>
                ...
                <div class="collapse navbar-collapse" id="navbarsExample07">
                    <ul class="nav navbar-nav mma_head">
                        ...
                        <li class="nav-item"> <a href="/section/Mind"> <img
                                    src="{{ asset('images/mind.png') }}" alt="" width="80"
                                    height="60"><br>
                                <span style="color: #D55783">Mind</span> </a> </li>
                        <li class="nav-item"> <a href="/section/Body"> <img
                                    src="{{ asset('images/body.png') }}" alt="" width="80"
                                    height="60"><br>
                                <span style="color: #6FC3DC">Body</span> </a> </li>
                        <li class="nav-item"> <a href="/section/Soul"> <img
                                    src="{{ asset('images/soul.png') }}" alt="" width="80"
                                    height="60"><br>
                                <span style="color: #F8D047">Soul</span> </a> </li>
                        <li class="nav-item">
                            <a href="/section/Toolkit/Toolkit"> <img
                                    src="{{ asset('images/toolkit_logo.png') }}" alt="" width="80"
                                    height="60"><br>
                                Toolkit
                            </a>
                        </li>
                        <li class="nav-item"> <a href="#"> <img
                                    src="{{ asset('images/logout.png') }}" alt="" width="80"
                                    height="60"><br>
                                Logout </a>
                        </li>
                    </ul>
